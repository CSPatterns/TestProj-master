...
//                LocationEntry.CONTENT_TYPE, type);
    ...
    public void testBasicMovieQuery() {
        ...
        ContentValues movieItemValues = TestUtilities.createMovieItemValues();
        long movieRowId = TestUtilities.insertMovieItemValues(mContext);

//        // Fantastic.  Now that we have a movies, add some reviews!
//        ContentValues reviewValues = TestUtilities.createInterstellarMovieReviewValues();
//
//        long reviewRowId = db.insert(ReviewEntry.TABLE_NAME, null, reviewValues);
        ...
        TestUtilities.validateCursor("testBasicMovieQuery", weatherCursor, movieItemValues);
    }
    ...
    public void testBasicReviewQuery() {
        ...
        long reviewRowId = TestUtilities.insertinterstellarMovieReviewValues(mContext);

        assertTrue("Unable to Insert WeatherEntry into the Database", reviewRowId != -1);
        ...
        // Make sure we get the correct cursor out of the database
        TestUtilities.validateCursor("testBasicMovieQuery", weatherCursor, testValues);
    }
    */
...
////        mContext.getContentResolver().registerContentObserver(ReviewEntry.CONTENT_URI, true, locationObserver);
//
...
//        long millisecondsInADay = 1000*60*60*24;
        ...
        for ( int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++) {
            ...
            movieValues.put(MovieEntry.COLUMN_ID, 21);
            movieValues.put(MovieEntry.COLUMN_TITLE, "Test title");
            movieValues.put(MovieEntry.COLUMN_IMAGE, "Test image");
            movieValues.put(MovieEntry.COLUMN_IMAGE2, "Test img2");
            movieValues.put(MovieEntry.COLUMN_OVERVIEW, "Test overview");
            movieValues.put(MovieEntry.COLUMN_RATING, "9");
            movieValues.put(MovieEntry.COLUMN_RELEASEDATE, "20 Jun 2015");
            movieValues.put(MovieEntry.COLUMN_FAVFLAG, "0");
